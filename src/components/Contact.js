...
<div className='container mx-auto'>
  <div className='flex flex-col lg:flex-row'>
    ...
    action="mailto:azizmuxtorqulov@gmail.com"
    >
      ...
      />
      <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white focus:border-accent resize-none mb-12 transition-all'
